...
<?php echo HTML::style('guide-media/css/huia.css', NULL, TRUE); ?>
...
<body>
	...
	<div id="kodoc-header">
		<div class="container">
			<a href="<?php echo Route::url('docs/guide') ?>" id="kodoc-logo">
				<img src="<?php echo Route::url('docs/media', array('file' => 'img/logo-huia.png')) ?>" />
			</a>
			<div id="kodoc-menu">
				<ul>
